...
$(document).ready(function () {
  ...
  $("#funcion").change(function () {
    ...
    $(
      ".deporte, .rama, .categoria, .peso, .prueba, .fnDeportista, .fnEntrenadores"
    )
      .css("display", "none")
      .val("");
  ...
  $("#formInformes").submit(function (e) {
    ...
    array1 = [1, 2, 4];
    array2 = [1, 2];
    let nombre = $.trim($("#formInformes #nombre").val());
    let curp = $.trim($("#formInformes #curp").val());
    let apellidos = $.trim($("#formInformes #apellidos").val());
    let ciclo = parseInt($("#formInformes #ciclo").val());
    let escuela = $.trim($("#formInformes #escuela").val());
    let funcion = parseInt($("#formInformes #funcion").val());
    let deporte = parseInt($("#deporte").val()) || 0;
    let rama = parseInt($("#rama").val()) || 0;
    let categoria = parseInt($("#categoria").val()) || 0;
    let peso = parseInt($("#peso").val()) || 0;
    let prueba = parseInt($("#prueba").val()) || 0;
    let prueba2 = parseInt($("#prueba2").val()) || 0;
